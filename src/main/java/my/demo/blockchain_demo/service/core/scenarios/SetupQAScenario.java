...
import my.demo.blockchain_demo.service.core.contract.functions.GetApprovedCurrency;
...
public class SetupQAScenario extends TreasuryCall {
    ...
    public SetupQAScenario(EthJsonRpcExt rpcClient, AppConfiguration appConfiguration, FunctionEncoder functionEncoder, FunctionParser functionParser, FunctionConverter converter, ApplicationShutdownManager shutdownManager) {
