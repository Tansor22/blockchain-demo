...
public class BlockchainAccessor {
    ...
    public void go() throws Exception {
        ...
        var tx = RawTransaction.createTransaction(chainId.longValue(), nonce, GAS_LIMIT, appConfiguration.oracleAddress(),
        ...
        var signedMessage = TransactionEncoder.signMessage(tx, chainId.longValue(), credentials);
